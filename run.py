...
from measure.schemes.windowsizeeffect import WindowSizeEffect
...
scheme = WindowSizeEffect(coincidence_circuit=coincidence_circuit, interferometer=interferometer)
